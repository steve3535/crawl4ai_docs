...
[SCRAPE].. ◆ Processed https://docs.gitlab.com/ee/user/packages/container... | Time: 683ms
[COMPLETE] ● https://docs.gitlab.com/ee/user/packages/container... | Status: True | Total: 0.70s
...
[ Getting started ](/ee/administration/get_started.html) [ All feature flags ](/ee/user/feature_flags.html)
...
[ Object storage ](/ee/administration/object_storage.html) [ Merge request diffs storage ](/ee/administration/merge_request_diffs.html) [ Static objects external storage ](/ee/administration/static_objects_external_storage.html) [ Geo ](/ee/administration/geo/)
...
[ Maintain GitLab ](/ee/administration/operations/)
...
[ GitLab Dedicated ](/ee/administration/dedicated/)
...
[ License scanning of CycloneDX files ](/ee/user/compliance/license_scanning_of_cyclonedx_files/) [ License approval policies ](/ee/user/compliance/license_approval_policies.html)
...
[ Active sessions ](/ee/user/profile/active_sessions.html) [ Comment templates ](/ee/user/profile/comment_templates.html) [ Contributions calendar ](/ee/user/profile/contributions_calendar.html) [ Achievements ](/ee/user/profile/achievements.html) [ Roles and permissions ](/ee/user/permissions.html)

[ Custom roles ](/ee/user/custom_roles.html) [ Custom permissions ](/ee/user/custom_roles/abilities.html)
...
[ GitLab (file export) ](/ee/user/project/settings/import_export.html)
...
[ Comments and threads ](/ee/user/discussions/) [ Tasks ](/ee/user/tasks.html) [ Requirements ](/ee/user/project/requirements/) [ Time tracking ](/ee/user/project/time_tracking.html) [ Customer relations (CRM) ](/ee/user/crm/) [ Wikis ](/ee/user/project/wiki/)
...
[ Forks ](/ee/user/project/repository/forking_workflow.html) [ File management ](/ee/user/project/repository/files/)
...
[ Troubleshooting ](/ee/ci/pipelines/downstream_pipelines_troubleshooting.html)
...
[ Git submodules ](/ee/ci/runners/git_submodules.html) [ Access a terminal for a running job ](/ee/ci/interactive_web_terminal/) [ CI/CD job logs ](/ee/ci/jobs/job_logs.html)
...
[ Requirements ](/ee/topics/autodevops/requirements.html) [ Stages ](/ee/topics/autodevops/stages.html) [ Customize ](/ee/topics/autodevops/customize.html)
...
[ Getting started ](/ee/user/application_security/get-started-security.html) [ Application security ](/ee/user/application_security/)
...
[ Security dashboard ](/ee/user/application_security/security_dashboard/) [ Offline environments ](/ee/user/application_security/offline_deployments/) [ Vulnerability Report ](/ee/user/application_security/vulnerability_report/)
...
[ OpenTofu state ](/ee/user/infrastructure/iac/terraform_state.html) [ OpenTofu integration in merge requests ](/ee/user/infrastructure/iac/mr_integration.html) [ GitLab Terraform helpers ](/ee/user/infrastructure/iac/gitlab_terraform_helpers.html) [ Terraform template recipes ](/ee/user/infrastructure/iac/terraform_template_recipes.html) [ Troubleshooting ](/ee/user/infrastructure/iac/troubleshooting.html)
...
[ Getting started ](/ee/user/get_started/get_started_monitoring.html) [ Error tracking ](/ee/operations/error_tracking.html)
...
[ On-call schedules ](/ee/operations/incident_management/oncall_schedules.html)
...
[ Set up Code Suggestions ](/ee/user/project/repository/code_suggestions/set_up.html) [ Supported extensions and languages ](/ee/user/project/repository/code_suggestions/supported_extensions.html) [ Troubleshooting ](/ee/user/project/repository/code_suggestions/troubleshooting.html) [ Repository X-Ray ](/ee/user/project/repository/code_suggestions/repository_xray.html)
...
[ Troubleshooting ](/ee/integration/elasticsearch/troubleshooting/)

[ Access ](/ee/integration/elasticsearch/troubleshooting/access.html) [ Indexing ](/ee/integration/elasticsearch/troubleshooting/indexing.html) [ Migrations ](/ee/integration/elasticsearch/troubleshooting/migrations.html)
...
[ Follow and unfollow users ](/ee/api/user_follow_unfollow.html) [ Service account users ](/ee/api/user_service_accounts.html) [ SSH and GPG keys ](/ee/api/user_keys.html) [ User email addresses ](/ee/api/user_email_addresses.html) [ User moderation ](/ee/api/user_moderation.html) [ User tokens ](/ee/api/user_tokens.html)
...
[ Install and set up ](/ee/editor_extensions/visual_studio_code/setup.html) [ CI/CD pipelines ](/ee/editor_extensions/visual_studio_code/cicd.html) [ Custom queries ](/ee/editor_extensions/visual_studio_code/custom_queries.html) [ GitLab remote URL format ](/ee/editor_extensions/visual_studio_code/remote_urls.html) [ Settings and commands ](/ee/editor_extensions/visual_studio_code/settings.html) [ Troubleshooting ](/ee/editor_extensions/visual_studio_code/troubleshooting.html) [ Using with self-signed certificates ](/ee/editor_extensions/visual_studio_code/ssl.html)

[ JetBrains IDEs ](/ee/editor_extensions/jetbrains_ide/)

[ Install and set up ](/ee/editor_extensions/jetbrains_ide/setup.html) [ Troubleshooting ](/ee/editor_extensions/jetbrains_ide/jetbrains_troubleshooting.html)

[ Visual Studio ](/ee/editor_extensions/visual_studio/)

[ Install and set up ](/ee/editor_extensions/visual_studio/setup.html) [ Troubleshooting ](/ee/editor_extensions/visual_studio/visual_studio_troubleshooting.html)

[ Neovim ](/ee/editor_extensions/neovim/)

[ Install and set up ](/ee/editor_extensions/neovim/setup.html) [ Troubleshooting ](/ee/editor_extensions/neovim/neovim_troubleshooting.html)
...
[ Contribute code with the Web IDE ](/ee/development/contributing/first_contribution/contribute-web-ide.html) [ Configure the Gitpod development environment ](/ee/development/contributing/first_contribution/configure-dev-env-gitpod.html) [ Contribute code with Gitpod ](/ee/development/contributing/first_contribution/contribute-gitpod.html) [ Configure GDK-in-a-box ](/ee/development/contributing/first_contribution/configure-dev-env-gdk-in-a-box.html) [ Install the GDK development environment ](/ee/development/contributing/first_contribution/configure-dev-env-gdk.html) [ Contribute code with GDK ](/ee/development/contributing/first_contribution/contribute-gdk.html) [ Create a merge request ](/ee/development/contributing/first_contribution/mr-review.html) [ Contribute to UX design ](/ee/development/ux/)
...
[ Merge request diffs development guide ](/ee/development/merge_request_concepts/diffs/development.html) [ Working with diffs ](/ee/development/merge_request_concepts/diffs/) [ Application and rate limit guidelines ](/ee/development/merge_request_concepts/rate_limits.html) [ Frontend overview ](/ee/development/merge_request_concepts/diffs/frontend.html) [ Mergeability framework ](/ee/development/merge_request_concepts/mergeability_framework.html) [ Performance guidelines ](/ee/development/merge_request_concepts/performance.html)

[ Merge request workflow ](/ee/development/contributing/merge_request_workflow.html) [ Profiling ](/ee/development/profiling.html) [ Rails Endpoints ](/ee/development/rails_endpoints/) [ Rails initializers ](/ee/development/rails_initializers.html) [ Rails upgrade guidelines ](/ee/development/rails_update.html) [ Reusing Abstractions ](/ee/development/reusing_abstractions.html) [ Renaming features ](/ee/development/renaming_features.html) [ Repository mirroring ](/ee/development/repository_mirroring.html) [ Ruby upgrade guidelines ](/ee/development/ruby_upgrade.html) [ Ruby 3 gotchas ](/ee/development/ruby3_gotchas.html) [ Secure partner onboarding process ](/ee/development/integrations/secure_partner_integration.html) [ Shared files ](/ee/development/shared_files.html) [ Storage ](/ee/development/file_storage.html) [ Testing standards and styles ](/ee/development/testing_guide/)

[ Flaky tests ](/ee/development/testing_guide/flaky_tests.html) [ Frontend testing standards and style guidelines ](/ee/development/testing_guide/frontend_testing.html) [ Review apps ](/ee/development/testing_guide/review_apps.html) [ Smoke tests ](/ee/development/testing_guide/smoke.html) [ Testing best practices ](/ee/development/testing_guide/best_practices.html) [ Test results tracking ](/ee/development/testing_guide/test_results_tracking.html) [ Testing levels ](/ee/development/testing_guide/testing_levels.html) [ Testing Rails migrations ](/ee/development/testing_guide/testing_migrations_guide.html) [ Testing Rake tasks ](/ee/development/testing_guide/testing_rake_tasks.html) [ Unhealthy tests ](/ee/development/testing_guide/unhealthy_tests.html) [ Vue 3 testing ](/ee/development/testing_guide/testing_vue3.html)

[ Testing (contract) ](/ee/development/testing_guide/contract/)

[ Writing consumer tests ](/ee/development/testing_guide/contract/consumer_tests.html) [ Writing provider tests ](/ee/development/testing_guide/contract/provider_tests.html)

[ Testing (end to end) ](/ee/development/testing_guide/end_to_end/)

[ Beginner's guide to writing end-to-end tests ](/ee/development/testing_guide/end_to_end/beginners_guide/)

[ Flows ](/ee/development/testing_guide/end_to_end/beginners_guide/flows.html) [ Page objects ](/ee/development/testing_guide/end_to_end/beginners_guide/page_objects.html) [ Resources ](/ee/development/testing_guide/end_to_end/beginners_guide/resources.html)

[ Best practices when writing end-to-end tests ](/ee/development/testing_guide/end_to_end/best_practices/)

[ Dynamic element validation ](/ee/development/testing_guide/end_to_end/best_practices/dynamic_element_validation.html) [ Execution context selection ](/ee/development/testing_guide/end_to_end/best_practices/execution_context_selection.html) [ Testing with feature flags ](/ee/development/testing_guide/end_to_end/best_practices/feature_flags.html) [ RSpec metadata for end-to-end tests ](/ee/development/testing_guide/end_to_end/best_practices/rspec_metadata_tests.html) [ Test Users ](/ee/development/testing_guide/end_to_end/best_practices/users.html) [ Waits ](/ee/development/testing_guide/end_to_end/best_practices/waits.html)

[ Migrate Capybara to Chemlab ](/ee/development/testing_guide/end_to_end/capybara_to_chemlab_migration_guide.html) [ End-to-end test pipelines ](/ee/development/testing_guide/end_to_end/test_pipelines.html) [ Running tests ](/ee/development/testing_guide/end_to_end/running_tests/)

[ Running tests that require special setup ](/ee/development/testing_guide/end_to_end/running_tests/running_tests_that_require_special_setup.html)

[ Style guide for writing end-to-end tests ](/ee/development/testing_guide/end_to_end/style_guide.html) [ Test Infrastructure for Cloud Integrations ](/ee/development/testing_guide/end_to_end/test_infrastructure.html) [ Troubleshooting ](/ee/development/testing_guide/end_to_end/troubleshooting.html)

[ Translate GitLab ](/ee/development/i18n/)

[ Externalization ](/ee/development/i18n/externalization.html) [ Translation ](/ee/development/i18n/translation.html) [ Proofreading ](/ee/development/i18n/proofreader.html) [ Merging ](/ee/development/i18n/merging_translations.html)

[ Development style guides ](/ee/development/contributing/style_guides.html)

[ Advanced search migration style guide ](/ee/development/search/advanced_search_migration_styleguide.html) [ API style guide ](/ee/development/api_styleguide.html) [ Caching guidelines ](/ee/development/caching.html) [ Frontend style guides ](/ee/development/fe_guide/style/) [ Frontend Goals ](/ee/development/fe_guide/frontend_goals.html) [ Gemfile guidelines ](/ee/development/gemfile.html) [ Gems development guidelines ](/ee/development/gems.html) [ Go standards and style guidelines ](/ee/development/go_guide/)

[ Dependency management in Go ](/ee/development/go_guide/dependencies.html) [ Managing Go versions ](/ee/development/go_guide/go_upgrade.html)

[ GraphQL API style guide ](/ee/development/api_graphql_styleguide.html) [ Shell command guidelines ](/ee/development/shell_commands.html) [ HTML style guide ](/ee/development/fe_guide/style/html.html) [ JavaScript style guide ](/ee/development/fe_guide/style/javascript.html) [ Performance guidelines ](/ee/development/performance.html) [ Python guidelines ](/ee/development/python_guide/) [ Refactoring guide ](/ee/development/refactoring_guide/) [ RuboCop rule guidelines ](/ee/development/rubocop_development_guide.html) [ Ruby style guide ](/ee/development/backend/ruby_style_guide.html) [ SCSS style guide ](/ee/development/fe_guide/style/scss.html) [ Secure coding guidelines ](/ee/development/secure_coding_guidelines.html) [ Service measurement ](/ee/development/service_measurement.html) [ Software design guides ](/ee/development/software_design.html) [ State management ](/ee/development/fe_guide/state_management.html)

[ Pinia ](/ee/development/fe_guide/pinia.html)

[ Shell scripting standards and style guidelines ](/ee/development/shell_scripting_guide/) [ TypeScript style guide ](/ee/development/fe_guide/style/typescript.html) [ Vue style guide ](/ee/development/fe_guide/style/vue.html)

[ Feature development ](/ee/development/feature_development.html)

[ ActivityPub ](/ee/development/activitypub/)

[ ActivityPub actors ](/ee/development/activitypub/actors/) [ Releases actor ](/ee/development/activitypub/actors/releases.html)

[ Advanced search ](/ee/development/advanced_search.html) [ AI ](/ee/development/ai_architecture.html) [ Application limits ](/ee/development/application_limits.html) [ Application secrets ](/ee/development/application_secrets.html) [ Application settings ](/ee/development/application_settings.html)

[ Cascading settings ](/ee/development/cascading_settings.html)

[ Application SLIs ](/ee/development/application_slis/)

[ Rails Request SLIs ](/ee/development/application_slis/rails_request.html) [ Sidekiq Execution SLIs ](/ee/development/application_slis/sidekiq_execution.html)

[ Approval rules ](/ee/development/merge_request_concepts/approval_rules.html) [ Audit events ](/ee/development/audit_event_guide/) [ Auto DevOps ](/ee/development/auto_devops.html) [ Backup and Restore ](/ee/development/backup_and_restore/backup_gitlab.html) [ Built-in project templates ](/ee/development/project_templates.html) [ Cells ](/ee/development/cells/)

[ Topology Service ](/ee/development/cells/topology_service.html)

[ CI/CD ](/ee/development/cicd/)

[ Documenting keywords ](/ee/development/cicd/cicd_reference_documentation_guide.html) [ Contribute to the CI/CD configuration ](/ee/development/cicd/configuration.html) [ Contribute to the CI/CD schema ](/ee/development/cicd/schema.html) [ CI/CD component development ](/ee/development/cicd/components.html) [ CI/CD template development ](/ee/development/cicd/templates.html) [ Pipeline Wizard ](/ee/development/cicd/pipeline_wizard.html) [ New partitioned CI/CD tables ](/ee/development/cicd/cicd_tables.html)

[ Code comments ](/ee/development/code_comments.html) [ Code intelligence ](/ee/development/code_intelligence/) [ Code Owners ](/ee/development/code_owners/) [ Code Suggestions ](/ee/development/code_suggestions/) [ Source Code Management ](/ee/development/backend/create_source_code_be/)

[ Gitaly touch points ](/ee/development/backend/create_source_code_be/gitaly_touch_points.html) [ Push Rules development guidelines ](/ee/development/push_rules/)

[ Data science ](/ee/development/data_science/)

[ Model registry ](/ee/development/data_science/model_registry/)

[ Data Seeder ](/ee/development/data_seeder.html) [ Database ](/ee/development/database/)

[ Adding database indexes ](/ee/development/database/adding_database_indexes.html) [ Database required stops ](/ee/development/database/required_stops.html) [ Add a foreign key constraint to an existing column ](/ee/development/database/add_foreign_key_to_existing_column.html) [ Avoiding downtime in migrations ](/ee/development/database/avoiding_downtime_in_migrations.html) [ Batched background migrations ](/ee/development/database/batched_background_migrations.html) [ Batching best practices ](/ee/development/database/batching_best_practices.html) [ Batch iteration in a tree hierarchy ](/ee/development/database/poc_tree_iterator.html) [ Cached queries guidelines ](/ee/development/cached_queries.html) [ Case study - filtering by label ](/ee/development/database/filtering_by_label.html) [ Case study - namespaces storage statistics ](/ee/development/database/namespaces_storage_statistics.html) [ CI mirrored tables ](/ee/development/database/ci_mirrored_tables.html) [ ClickHouse ](/ee/development/database/clickhouse/)

[ ClickHouse within GitLab ](/ee/development/database/clickhouse/clickhouse_within_gitlab.html) [ GitLab activity data in ClickHouse ](/ee/development/database/clickhouse/gitlab_activity_data.html) [ Merge request analytics with ClickHouse ](/ee/development/database/clickhouse/merge_request_analytics.html) [ Optimizing query execution ](/ee/development/database/clickhouse/optimization.html) [ Tiered storages in ClickHouse ](/ee/development/database/clickhouse/tiered_storage.html)

[ Client-side connection pool ](/ee/development/database/client_side_connection_pool.html) [ Constraint naming convention ](/ee/development/database/constraint_naming_convention.html) [ Database Dictionary ](/ee/development/database/database_dictionary.html) [ Database Lab and Postgres.ai ](/ee/development/database/database_lab.html) [ Database load balancing ](/ee/development/database/load_balancing.html) [ Database migration pipeline ](/ee/development/database/database_migration_pipeline.html) [ Database review guidelines ](/ee/development/database_review.html) [ Database reviewer guidelines ](/ee/development/database/database_reviewer_guidelines.html) [ Database check-migrations job ](/ee/development/database/dbcheck-migrations-job.html) [ DB Migrate multi-version upgrade job ](/ee/development/database/dbmigrate_multi_version_upgrade_job.html) [ DB dump ](/ee/development/database/db_dump.html) [ Deduplicate database records ](/ee/development/database/deduplicate_database_records.html) [ Delete existing migrations ](/ee/development/database/deleting_migrations.html) [ Enums ](/ee/development/database/creating_enums.html) [ Foreign keys and associations ](/ee/development/database/foreign_keys.html) [ Hash indexes ](/ee/development/database/hash_indexes.html) [ Insert into tables in batches ](/ee/development/database/insert_into_tables_in_batches.html) [ Introducing a new database migration version ](/ee/development/database/new_database_migration_version.html) [ Iterating tables in batches ](/ee/development/database/iterating_tables_in_batches.html) [ JiHu merge requests ](/ee/development/jh_features_review.html) [ Large tables limitations ](/ee/development/database/large_tables_limitations.html) [ Layout and access patterns ](/ee/development/database/layout_and_access_patterns.html) [ Maintenance operations ](/ee/development/database/maintenance_operations.html) [ Migration ordering ](/ee/development/database/migration_ordering.html) [ Migrations style guide ](/ee/development/migration_style_guide.html) [ Multiple databases ](/ee/development/database/multiple_databases.html)

[ Loose Foreign Keys ](/ee/development/database/loose_foreign_keys.html) [ Migrations for multiple databases ](/ee/development/database/migrations_for_multiple_databases.html)

[ Namespaces ](/ee/development/namespaces.html) [ Navigation sidebar ](/ee/development/navigation_sidebar.html) [ NOT NULL constraints ](/ee/development/database/not_null_constraints.html) [ Offset pagination optimization ](/ee/development/database/offset_pagination_optimization.html) [ Ordering table columns ](/ee/development/database/ordering_table_columns.html) [ Pagination guidelines ](/ee/development/database/pagination_guidelines.html)

[ Pagination performance guidelines ](/ee/development/database/pagination_performance_guidelines.html) [ Keyset pagination ](/ee/development/database/keyset_pagination.html) [ Efficient IN operator queries ](/ee/development/database/efficient_in_operator_queries.html)

[ Polymorphic associations ](/ee/development/database/polymorphic_associations.html) [ Post-deployment migrations ](/ee/development/database/post_deployment_migrations.html) [ Query comments with Marginalia ](/ee/development/database/database_query_comments.html) [ Query count limits ](/ee/development/database/query_count_limits.html) [ Query performance guidelines ](/ee/development/database/query_performance.html) [ Query Recorder ](/ee/development/database/query_recorder.html) [ Rename database tables ](/ee/development/database/rename_database_tables.html) [ Scalability patterns ](/ee/development/database/scalability/patterns/)

[ Read-mostly pattern ](/ee/development/database/scalability/patterns/read_mostly.html) [ Time decay pattern ](/ee/development/database/scalability/patterns/time_decay.html)

[ Serializing data ](/ee/development/database/serializing_data.html) [ Setting multiple values ](/ee/development/database/setting_multiple_values.html) [ SHA1 as binary ](/ee/development/database/sha1_as_binary.html) [ Single Table Inheritance ](/ee/development/database/single_table_inheritance.html) [ Semantic Versioning of Database Records ](/ee/development/semver.html) [ SQL guidelines ](/ee/development/sql.html) [ Strings and the Text data type ](/ee/development/database/strings_and_the_text_data_type.html) [ Swapping tables ](/ee/development/database/swapping_tables.html) [ Table partitioning ](/ee/development/database/partitioning/)

[ Date range ](/ee/development/database/partitioning/date_range.html) [ Hash ](/ee/development/database/partitioning/hash.html) [ Int range ](/ee/development/database/partitioning/int_range.html) [ List ](/ee/development/database/partitioning/list.html)

[ Transaction guidelines ](/ee/development/database/transaction_guidelines.html) [ Troubleshooting and debugging ](/ee/development/database/database_debugging.html) [ Understanding EXPLAIN plans ](/ee/development/database/understanding_explain_plans.html) [ Verifying database capabilities ](/ee/development/database/verifying_database_capabilities.html)

[ Design and UI ](/ee/development/contributing/design.html) [ Development seed files ](/ee/development/development_seed_files.html) [ Distributed tracing ](/ee/development/tracing.html)

[ Development guidelines ](/ee/development/distributed_tracing.html)

[ Event Store ](/ee/development/event_store.html) [ Export CSV ](/ee/development/export_csv.html) [ Frontend development ](/ee/development/fe_guide/)

[ Accessibility ](/ee/development/fe_guide/accessibility/)

[ Best practices ](/ee/development/fe_guide/accessibility/best_practices.html) [ Automated testing ](/ee/development/fe_guide/accessibility/automated_testing.html)

[ Architecture ](/ee/development/fe_guide/architecture.html)

[ Content Editor ](/ee/development/fe_guide/content_editor.html) [ Customizable dashboards ](/ee/development/fe_guide/customizable_dashboards.html) [ Design tokens ](/ee/development/fe_guide/design_tokens.html) [ Diagrams.net ](/ee/development/fe_guide/diagrams_net_integration.html) [ Merge request widget extensions ](/ee/development/fe_guide/merge_request_widgets.html) [ Registry architecture ](/ee/development/fe_guide/registry_architecture.html) [ Source editor ](/ee/development/fe_guide/source_editor.html) [ Storybook ](/ee/development/fe_guide/storybook.html) [ Widgets ](/ee/development/fe_guide/widgets.html)

[ Cookies ](/ee/development/cookies.html) [ Dark mode ](/ee/development/fe_guide/dark_mode.html) [ Date and time ](/ee/development/fe_guide/date_and_time.html) [ Dependencies ](/ee/development/fe_guide/dependencies.html) [ Design patterns ](/ee/development/fe_guide/design_patterns.html) [ Event tracking ](https://handbook.gitlab.com/handbook/product/analytics-instrumentation-guide/) [ Emojis ](/ee/development/fe_guide/emojis.html) [ FAQ ](/ee/development/fe_guide/frontend_faq.html) [ Guides ](/ee/development/fe_guide/guides.html)

[ Getting started ](/ee/development/fe_guide/getting_started.html) [ Migrating from Vuex ](/ee/development/fe_guide/migrating_from_vuex.html) [ Onboarding course ](/ee/development/fe_guide/onboarding_course/)
...
[ Icons and SVG illustrations ](/ee/development/fe_guide/icons.html) [ Keyboard shortcuts ](/ee/development/fe_guide/keyboard_shortcuts.html) [ Logging ](/ee/development/fe_guide/logging.html) [ Sentry ](/ee/development/fe_guide/sentry.html) [ Performance ](/ee/development/fe_guide/performance.html) [ Security ](/ee/development/fe_guide/security.html) [ Tech Stack ](/ee/development/fe_guide/tech_stack.html)

[ Axios ](/ee/development/fe_guide/axios.html) [ GraphQL ](/ee/development/fe_guide/graphql.html) [ HAML ](/ee/development/fe_guide/haml.html) [ ViewComponent ](/ee/development/fe_guide/view_component.html) [ Vue ](/ee/development/fe_guide/vue.html) [ Vuex ](/ee/development/fe_guide/vuex.html) [ Tooling ](/ee/development/fe_guide/tooling.html)

[ Troubleshooting ](/ee/development/fe_guide/troubleshooting.html) [ Type hinting ](/ee/development/fe_guide/type_hinting.html)

[ Geo ](/ee/development/geo.html)

[ Geo framework ](/ee/development/geo/framework.html) [ Geo proxying ](/ee/development/geo/proxying.html) [ Geo API ](/ee/development/geo/api.html)

[ Git LFS ](/ee/development/lfs.html) [ Git object deduplication ](/ee/development/git_object_deduplication.html) [ Gitaly ](/ee/development/gitaly.html) [ GitLab Flavored Markdown (GLFM) ](/ee/development/gitlab_flavored_markdown/)

[ Reference processing ](/ee/development/gitlab_flavored_markdown/reference_processing.html)

[ GitLab Shell ](/ee/development/gitlab_shell/)

[ Features ](/ee/development/gitlab_shell/features.html) [ GitLab-sshd ](/ee/development/gitlab_shell/gitlab_sshd.html) [ Processes ](/ee/development/gitlab_shell/process.html)

[ Gitpod internal configuration ](/ee/development/gitpod_internals.html) [ GraphQL ](/ee/development/graphql_guide/)

[ GraphQL authorization ](/ee/development/graphql_guide/authorization.html) [ GraphQL BatchLoader ](/ee/development/graphql_guide/batchloader.html) [ Reading GraphQL logs ](/ee/development/graphql_guide/monitoring.html) [ GraphQL pagination ](/ee/development/graphql_guide/pagination.html) [ GraphQL Pro ](/ee/development/graphql_guide/graphql_pro.html) [ GraphQL API merge request checklist ](/ee/development/graphql_guide/reviewing.html)

[ Generating chaos ](/ee/development/chaos_endpoints.html) [ Group-level project templates ](/ee/development/project_templates/) [ Principles of Importer Design ](/ee/development/import/principles_of_importer_design.html)

[ Import (Bitbucket Cloud) ](/ee/development/bitbucket_cloud_importer.html) [ Import (Bitbucket Server) ](/ee/development/bitbucket_server_importer.html) [ Import (GitHub) ](/ee/development/github_importer.html) [ Import (Migration by direct transfer) ](/ee/development/bulk_import.html)

[ Add relations to direct transfer importer ](/ee/development/bulk_imports/contributing.html)

[ Import (Migration by file export) ](/ee/development/import_export.html) [ Import (test project) ](/ee/development/import_project.html)

[ Identity verification ](/ee/development/identity_verification.html) [ Integrations ](/ee/development/integrations/) [ Internal analytics ](/ee/development/internal_analytics/)

[ Internal event tracking ](/ee/development/internal_analytics/internal_event_instrumentation/)

[ Quick start guide ](/ee/development/internal_analytics/internal_event_instrumentation/quick_start.html) [ Migrating to internal event tracking ](/ee/development/internal_analytics/internal_event_instrumentation/migration.html) [ Event definition guide ](/ee/development/internal_analytics/internal_event_instrumentation/event_definition_guide.html) [ Metric definition guide ](/ee/development/internal_analytics/internal_event_instrumentation/metric_definition_guide.html) [ Local setup and debugging ](/ee/development/internal_analytics/internal_event_instrumentation/local_setup_and_debugging.html)

[ Metrics ](/ee/development/internal_analytics/metrics/)

[ Metrics dictionary guide ](/ee/development/internal_analytics/metrics/metrics_dictionary.html) [ Metrics instrumentation guide ](/ee/development/internal_analytics/metrics/metrics_instrumentation.html) [ Metrics lifecycle ](/ee/development/internal_analytics/metrics/metrics_lifecycle.html)
...
[ Review guidelines ](/ee/development/internal_analytics/review_guidelines.html)

[ Internal API ](/ee/development/internal_api/)

[ Internal allowed API ](/ee/development/internal_api/internal_api_allowed.html) [ GitLab Subscriptions ](/ee/development/internal_api/gitlab_subscriptions.html)

[ Internal users ](/ee/development/internal_users.html) [ Issuable-like Rails models utilities ](/ee/development/issuable-like-models.html) [ Issue types ](/ee/development/issue_types.html) [ Jenkins in local environments ](/ee/development/integrations/jenkins.html) [ Jira development environment ](/ee/development/integrations/jira_connect.html) [ JSON guidelines ](/ee/development/json.html) [ Kubernetes integration ](/ee/development/kubernetes.html) [ Logging ](/ee/development/logging.html) [ Observability ](/ee/development/observability/)

[ Metrics ](/ee/development/metrics.html) [ Logs ](/ee/development/logs.html) [ Tutorial: Use GitLab Observability with a Ruby on Rails application ](/ee/tutorials/observability/observability_rails_tutorial.html) [ Tutorial: Use GitLab Observability with a NodeJS application ](/ee/tutorials/observability/observability_nodejs_tutorial.html) [ Tutorial: Use GitLab Observability with a Django application ](/ee/tutorials/observability/observability_django_tutorial.html) [ Tutorial: Use GitLab Observability with a Java Spring application ](/ee/tutorials/observability/observability_java_tutorial.html) [ Tutorial: Use GitLab Observability with a .NET application ](/ee/tutorials/observability/observability_dotnet_tutorial.html)

[ Observability for stage groups ](/ee/development/stage_group_observability/)

[ Dashboards ](/ee/development/stage_group_observability/dashboards/) [ GitLab instrumentation for OpenTelemetry ](/ee/development/stage_group_observability/gitlab_instrumentation_for_opentelemetry.html) [ Stage group dashboard ](/ee/development/stage_group_observability/dashboards/stage_group_dashboard.html) [ Error budget detail ](/ee/development/stage_group_observability/dashboards/error_budget_detail.html)

[ Package ](/ee/development/packages/)

[ Package settings ](/ee/development/packages/settings.html) [ Package structure ](/ee/development/packages/structure.html) [ Support new formats ](/ee/development/packages/new_format_development.html) [ Cleanup policies ](/ee/development/packages/cleanup_policies.html) [ Debian repository ](/ee/development/packages/debian_repository.html) [ Dependency proxy ](/ee/development/packages/dependency_proxy.html) [ Harbor registry ](/ee/development/packages/harbor_registry_development.html)

[ Permissions ](/ee/development/permissions.html)

[ Predefined system of user roles ](/ee/development/permissions/predefined_roles.html) [ Custom roles ](/ee/development/permissions/custom_roles.html) [ Permissions Conventions ](/ee/development/permissions/conventions.html) [ Authorization ](/ee/development/permissions/authorizations.html)

[ Product Qualified Lead (PQL) ](/ee/development/product_qualified_lead_guide/) [ Pry debugging ](/ee/development/pry_debugging.html) [ VS Code debugging ](/ee/development/vs_code_debugging.html) [ Build and deploy real-time view components ](/ee/development/real_time.html) [ Redis ](/ee/development/redis.html)

[ Add a Redis instance ](/ee/development/redis/new_redis_instance.html)

[ Reactive caching ](/ee/development/reactive_caching.html) [ Remote Development developer documentation ](/ee/development/remote_development/) [ Repository storage moves ](/ee/development/repository_storage_moves/) [ Routing ](/ee/development/routing.html) [ Sec section ](/ee/development/sec/)

[ Analyzer development guide ](/ee/development/sec/analyzer_development_guide.html) [ CycloneDX property taxonomy ](/ee/development/sec/cyclonedx_property_taxonomy.html) [ Gemnasium analyzer data ](/ee/development/sec/gemnasium_analyzer_data.html) [ Security report ingestion ](/ee/development/sec/security_report_ingestion_overview.html) [ Token Revocation API ](/ee/development/sec/token_revocation_api.html) [ Generate test vulnerabilities ](/ee/development/sec/generate_test_vulnerabilities.html)

[ Sidekiq ](/ee/development/sidekiq/)

[ Compatibility across updates ](/ee/development/sidekiq/compatibility_across_updates.html) [ Job idempotency and job deduplication ](/ee/development/sidekiq/idempotent_jobs.html) [ Limited capacity worker ](/ee/development/sidekiq/limited_capacity_worker.html) [ Logging ](/ee/development/sidekiq/logging.html) [ Worker attributes ](/ee/development/sidekiq/worker_attributes.html)

[ Solargraph ](/ee/development/developing_with_solargraph.html) [ Spam protection and CAPTCHA ](/ee/development/spam_protection_and_captcha/)

[ Model and services ](/ee/development/spam_protection_and_captcha/model_and_services.html) [ REST API spam protection ](/ee/development/spam_protection_and_captcha/rest_api.html) [ GraphQL API spam protection ](/ee/development/spam_protection_and_captcha/graphql_api.html) [ Web UI spam protection ](/ee/development/spam_protection_and_captcha/web_ui.html) [ Exploratory testing ](/ee/development/spam_protection_and_captcha/exploratory_testing.html)
...
[ Aggregated Value Stream Analytics ](/ee/development/value_stream_analytics/value_stream_analytics_aggregated_backend.html)

[ Verify stage ](/ee/development/contributing/verify/) [ Wikis ](/ee/development/wikis.html) [ Work items and work item types ](/ee/development/work_items.html) [ Work items widgets ](/ee/development/work_items_widgets.html) [ Workhorse ](/ee/development/workhorse/)

[ Adding new features to Workhorse ](/ee/development/workhorse/new_features.html) [ Configuration ](/ee/development/workhorse/configuration.html) [ Features that rely on Workhorse ](/ee/development/workhorse/gitlab_features.html) [ Handlers ](/ee/development/workhorse/handlers.html) [ Websocket channel support ](/ee/development/workhorse/channel.html)

[ Prometheus metrics ](/ee/development/prometheus_metrics.html) [ Organization ](/ee/development/organization/) [ Utilities ](/ee/development/utilities.html)

[ GitLab Development Kit ](https://gitlab.com/gitlab-org/gitlab-development-kit/-/blob/main/README.md) [ GitLab project pipelines ](/ee/development/pipelines/)

[ CI configuration internals ](/ee/development/pipelines/internals.html) [ CI configuration performance ](/ee/development/pipelines/performance.html)

[ Contribute to GitLab Runner ](/runner/development/)

[ Review GitLab Runner ](/runner/development/reviewing-gitlab-runner.html) [ Add new Windows version support for Docker executor ](/runner/development/add-windows-version.html)
...
[ Getting started ](/omnibus/development/contribute-to-omnibus-gitlab.html) [ Build locally ](/omnibus/build/)

[ Build Omnibus GitLab package ](/omnibus/build/build_package.html) [ Build all-in-one Docker image ](/omnibus/build/build_docker_image.html) [ Information for GitLab team members ](/omnibus/build/team_member_docs.html)

[ Set up a development environment ](/omnibus/development/setup.html)

[ Developing for s390x architecture ](/omnibus/development/s390x.html)

[ Test plans ](/omnibus/development/test-plans/)

[ Upgrade Component test plan template ](/omnibus/development/test-plans/upgrade-component-testplan-template.html) [ Upgrade golang ](/omnibus/development/test-plans/upgrade-golang-testplan.html) [ Upgrade exiftool ](/omnibus/development/test-plans/upgrade-exiftool-testplan.html) [ Upgrade rubygems ](/omnibus/development/test-plans/upgrade-rubygems-testplan.html) [ Upgrade Redis ](/omnibus/development/test-plans/upgrade-redis-testplan.html) [ Upgrade gitlab-exporter ](/omnibus/development/test-plans/upgrade-gitlab-exporter-testplan.html) [ Upgrade go-crond ](/omnibus/development/test-plans/upgrade-go-crond-testplan.html) [ Upgrade Mattermost ](/omnibus/development/test-plans/upgrade-mattermost-testplan.html)

[ Generate test report ](/omnibus/development/allure-test-report.html) [ Maintainership ](/omnibus/development/maintainership.html) [ CI variables ](/omnibus/development/ci-variables.html) [ Change package behavior ](/omnibus/development/change-package-behavior.html) [ Change YAML config options ](/omnibus/settings/gitlab.yml.html) [ Add deprecation messages ](/omnibus/development/adding-deprecation-messages.html) [ Add new gitlab-ctl commands ](/omnibus/development/gitlab-ctl-commands.html)

[ What happens with gitlab-ctl reconfigure ](/omnibus/development/reconfigure_in_detail.html)

[ Add new services ](/omnibus/development/new-services.html) [ Add new software definitions ](/omnibus/development/new-software-definition.html) [ Database support ](/omnibus/development/database_support.html) [ Create patches ](/omnibus/development/creating-patches.html) [ Add or remove configuration options ](/omnibus/development/add-remove-configuration-options.html) [ Manage PostgreSQL versions ](/omnibus/development/managing-postgresql-versions.html) [ Omnibus mirror ](/omnibus/development/omnibus-mirror.html) [ Version format for the packages and Docker images ](/omnibus/development/package_version_format.html) [ Pipelines ](/omnibus/development/pipelines.html) [ Work with public_attributes.json ](/omnibus/development/public-attributes.html) [ Release to AWS ](/omnibus/development/aws_amis_and_marketplace_listings.html) [ Upgrade software components ](/omnibus/development/upgrading-software-components.html) [ Upgrade Chef ](/omnibus/development/upgrading-chef.html) [ Handle vulnerabilities ](/omnibus/development/vulnerabilities.html) [ Handle broken master pipelines ](/omnibus/development/broken_master.html) [ Deprecate and remove support for an OS ](/omnibus/development/deprecating-and-removing-support-for-an-os.html)

[ Contribute to GitLab Helm charts ](/charts/development/)

[ Architecture of Cloud native GitLab Helm charts ](/charts/architecture/)

[ Backup and Restore ](/charts/architecture/backup-restore.html) [ Goals ](/charts/architecture/goals.html) [ Architecture ](/charts/architecture/architecture.html) [ Design Decisions ](/charts/architecture/decisions.html) [ Decision Making ](/charts/architecture/decision-making.html) [ Resource Usage ](/charts/architecture/resource-usage.html)

[ Environment setup ](/charts/development/environment_setup.html)

[ Developing for Kubernetes with KinD ](/charts/development/kind/) [ Developing for Kubernetes minikube ](/charts/development/minikube/)

[ Style guide ](/charts/development/style_guide.html)

[ Changelog entries ](/charts/development/changelog.html)

[ Running GitLab QA ](/charts/development/gitlab-qa/) [ Writing bats tests ](/charts/development/bats.html) [ Writing RSpec tests ](/charts/development/rspec.html) [ Testing with ChaosKube ](/charts/development/chaoskube/) [ Versioning and release ](/charts/development/release.html) [ Troubleshooting ](/charts/development/troubleshooting.html) [ ClickHouse database ](/charts/development/clickhouse.html) [ checkConfig template ](/charts/development/checkconfig.html) [ Validation of values using JSON schema ](/charts/development/validation.html) [ Deploy Development Branch ](/charts/development/deploy.html) [ Deprecations and removals ](/charts/development/deprecations.html)

[ Contribute to GitLab Operator ](/operator/developer/guide.html)

[ CI/CD configuration ](/operator/developer/ci.html) [ Dependency on GitLab Charts ](/operator/developer/charts_dependency.html) [ Development installation ](/operator/developer/installation.html) [ OpenShift cluster setup ](/operator/developer/openshift_cluster_setup.html) [ Publish to OperatorHub ](/operator/developer/operatorhub_publishing.html) [ Provision and deploy ](/operator/developer/provision_and_deploy.html) [ RedHat certification ](/operator/developer/redhat_certification.html) [ RedHat certification full ](/operator/developer/redhat_certification_full.html) [ Versioning and releases ](/operator/developer/releases.html) [ Test OLM ](/operator/developer/test_olm.html)

[ Contribute to GitLab Design System ](https://design.gitlab.com/get-started/contributing) [ Contribute to documentation ](/ee/development/documentation/)

[ Style guide ](/ee/development/documentation/styleguide/)

[ Recommended word list ](/ee/development/documentation/styleguide/word_list.html) [ Product availability details ](/ee/development/documentation/styleguide/availability_details.html) [ Feature flags ](/ee/development/documentation/feature_flags.html) [ Experiment and beta features ](/ee/development/documentation/experiment_beta.html) [ Deprecations and removals ](/ee/development/documentation/styleguide/deprecations_and_removals.html) [ Version-specific changes ](/ee/development/documentation/topic_types/version_specific_changes.html) [ Metadata ](/ee/development/documentation/metadata.html) [ GraphQL ](/ee/development/documentation/graphql_styleguide.html) [ REST API ](/ee/development/documentation/restful_api_styleguide.html)

[ Topic types ](/ee/development/documentation/topic_types/)

[ Concepts ](/ee/development/documentation/topic_types/concept.html) [ Tasks ](/ee/development/documentation/topic_types/task.html) [ Reference ](/ee/development/documentation/topic_types/reference.html) [ Troubleshooting ](/ee/development/documentation/topic_types/troubleshooting.html) [ Top-level ](/ee/development/documentation/topic_types/top_level_page.html) [ Getting started ](/ee/development/documentation/topic_types/get_started.html) [ Tutorials ](/ee/development/documentation/topic_types/tutorial.html) [ Glossaries ](/ee/development/documentation/topic_types/glossary.html)

[ Workflow ](/ee/development/documentation/workflow.html) [ /help ](/ee/development/documentation/help.html) [ Drawer content ](/ee/development/documentation/drawers.html) [ Testing ](/ee/development/documentation/testing/)

[ Links ](/ee/development/documentation/testing/links.html) [ markdownlint ](/ee/development/documentation/testing/markdownlint.html) [ Vale ](/ee/development/documentation/testing/vale.html)

[ Site architecture ](/ee/development/documentation/site_architecture/)

[ Global navigation ](/ee/development/documentation/site_architecture/global_nav.html) [ Folder structure ](/ee/development/documentation/site_architecture/folder_structure.html) [ Deployment process ](/ee/development/documentation/site_architecture/deployment_process.html) [ Documentation review apps ](/ee/development/documentation/review_apps.html) [ Automation ](/ee/development/documentation/site_architecture/automation.html)

[ Backport documentation changes ](/ee/development/documentation/backporting.html) [ Redirects ](/ee/development/documentation/redirects.html)

[ Solutions ](/ee/solutions/)

[ Cloud ](/ee/solutions/cloud/)

[ AWS Solutions ](/ee/solutions/cloud/aws/)

[ GitLab partnership qualifications from AWS ](/ee/solutions/cloud/aws/gitlab_aws_partner_designations.html) [ GitLab AWS integrations index ](/ee/solutions/cloud/aws/gitlab_aws_integration.html) [ GitLab Instances on AWS ](/ee/solutions/cloud/aws/gitlab_instance_on_aws.html) [ Provision GitLab on a single EC2 instance in AWS ](/ee/solutions/cloud/aws/gitlab_single_box_on_aws.html) [ SRE considerations for Gitaly on AWS ](/ee/solutions/cloud/aws/gitaly_sre_for_aws.html) [ GitLab and AWS Integration Tutorials ](/ee/solutions/cloud/aws/tutorials/)

[ Tutorial: Configuring AWS ECR Pull Through Cache Rules ](/ee/solutions/cloud/aws/tutorials/aws_ecr_pull_through_cache.html)

[ Coding Languages and Frameworks ](/ee/solutions/languages/)

[ Solutions Index for Rust ](/ee/solutions/languages/rust/)

[ Integrations ](/ee/solutions/integrations/)

[ ServiceNow ](/ee/solutions/integrations/servicenow.html)

[ About ](/ee/devsecops.html)

[ Use of generative AI ](/ee/legal/use_generative_ai.html)

# Subscribe to GitLab[](#subscribe-to-gitlab "Permalink")

Choose and manage the subscription that’s right for you and your organization. 

[**GitLab plans**](choosing_subscription.html)Options for GitLab plans. |  [**GitLab.com subscription**](gitlab_com/index.html)Seat usage, compute minutes, storage limits, renewal information. |  [**GitLab self-managed subscription**](self_managed/index.html)Billable users, renewal and upgrade information.   
---|---|---  
[**GitLab Dedicated**](gitlab_dedicated/index.html)Available features and benefits. |  [**GitLab Duo add-ons**](subscription-add-ons.html) Seat assignment, GitLab Duo Pro, Duo Enterprise. |  [**Community programs**](community_programs.html)Education, Open Source, Startups.   
[**The Customers Portal**](customers_portal.html)Payment and company details. |  [**Quarterly reconciliation and annual true-ups**](quarterly_reconciliation.html)Billing examples. |  [**Compute quota**](../ci/pipelines/compute_minutes.html)Calculations, quotas, purchase information.   
  
## [ Help & feedback  ](#help-feedback-content)

### Docs

[Edit this page](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/subscriptions/index.md) to fix an error or add an improvement in a merge request. [Create an issue](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issue\[description\]=Link%20the%20doc%20and%20describe%20what%20is%20wrong%20with%20it.%0A%0A%3C!--%20Don%27t%20edit%20below%20this%20line%20--%3E%0A%0A%2Flabel%20~documentation%20~%22docs%5C-comments%22%20&issue\[title\]=Docs%20feedback:%20Write%20your%20title) to suggest an improvement to this page. 
...
View [page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/subscriptions/index.md) - Edit in [Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/subscriptions/index.md) [![Creative Commons License](/assets/images/by-sa.svg)](https://creativecommons.org/licenses/by-sa/4.0/)
